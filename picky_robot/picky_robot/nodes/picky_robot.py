...
PUSH_TOPIC = '/ur5_motion/push_position'
...
class PickyRobot:
    ...
    def __init__(self, args):
        ...
        node = rclpy.create_node('picky_robot')
        self.pub = node.create_publisher(
            Float32, PUSH_TOPIC, qos_profile=qos_profile_sensor_data)
        sub = node.create_subscription(Detection3DArray,
